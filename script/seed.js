...
async function seed() {
  ...
  const users = await Promise.all([
    User.create({ username: 'Ryan', email: "ryan.cokely@gmail.com", birthday: "June 1, 1983",  password: '123', admin: true }),
    User.create({ username: 'Scott', email: "scottlcokely@gmail.com", birthday: "June 1, 1983", password: '123' }),
    User.create({ username: 'Matt',  email: "mclaise@gmail.com", birthday: "June 1, 1983", password: '123' }),
  ])

  const events = await Promise.all([
    Event.create({ eventName: '5k', description: 'Outdoor Run', endDate: "Jan 11, 2099", type: "Run", createdBy: "1"}),
    Event.create({ eventName: 'Pull-Ups', description: 'max reps', endDate: "Jan 12, 2099", type: "Random", createdBy: "1",image: "https://res.cloudinary.com/upskilled/image/fetch/w_600,h_400,c_crop,c_fill,g_face:auto,f_auto/https://www.upskilled.edu.au/getmedia%2Ff4633697-8724-4633-8488-825ec4a1587f%2Fchallenge-yourself-in-your-next-role-HERO.jpg%3B.aspx%3Fwidth%3D1000%26height%3D667%26ext%3D.jpg"}),
    Event.create({ eventName: '10k', description: 'run',  endDate: "Jan 10, 2099", type: "Run", createdBy: "1", }),
    Event.create({ eventName: '500 Meter Row', description: 'Indoor Erg Row',  endDate: "Jan 8, 2099", type: "Row", createdBy: "1", image: "https://www.byrdie.com/thmb/wt0s4-TZV_nQt3NXswXUYHil48Q=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/TheseOnlineRowingClassesWillHelpYouGetTonedinNoTime-a2959753b88f4ebb8ac9532971123761.jpg", }),
    Event.create({ eventName: 'Pushups', description: 'max reps',  endDate: "Jan 8, 2023", type: "Random", createdBy: "1", image: "https://res.cloudinary.com/upskilled/image/fetch/w_600,h_400,c_crop,c_fill,g_face:auto,f_auto/https://www.upskilled.edu.au/getmedia%2Ff4633697-8724-4633-8488-825ec4a1587f%2Fchallenge-yourself-in-your-next-role-HERO.jpg%3B.aspx%3Fwidth%3D1000%26height%3D667%26ext%3D.jpg" }),
